...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function closeAll(event) {
        // Закрытие всех элементов select
        ...
        // Закрытие элемента select-calendar
        ...
        // Закрытие элемента select-quantity
    ...
    selects.forEach(select => {
        ...
        selectText.addEventListener("click", (event) => {
            ...
            closeAll(event); // Закрыть другие селекты
            if (isOpen) {
                select.classList.remove("open");
                selectDropdown.classList.remove("show");
            } else {
    ...
    // Обработчик для закрытия всех элементов при клике вне их области
...
document.addEventListener("DOMContentLoaded", () => {
    document.querySelectorAll(".select-quantity").forEach(selectQuantity => {
        ...
        function updateText() {
            ...
            const resultText = values.length ? values.join(", ") : "Количество человек";
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!input || !label) return; // Если элементов нет, прерываем выполнение
